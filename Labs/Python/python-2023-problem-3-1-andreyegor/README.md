...
![заказчик](./pictures/santa.jpg)

Вам пришел срочный заказ из администрации университета! Близятся новогодние праздники, сессия и тайный Санта.
Поэтому просто необходимо реализовать простейшую базу данных, поддерживающую запросы для формирования выборки 
студентов и преподавателей, подходящих под заданные в запросах условия.
