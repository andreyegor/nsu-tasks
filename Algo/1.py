"""
Реализуйте алгоритм деления в столбик n-значного числа
на m-значное. Докажите, что он требует по порядку
величины m*n элементарных операций. Рассмотрите худший и
лучший случаи алгоритма, оцените количество операций для
них.
"""
