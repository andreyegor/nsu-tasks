...
3. Команду, которую нужно выполнить для проверки
ошибок на определенном коммите (если команда
возвращает error code отличный от 0, то коммит -
плохой)

Протестировать решение на специально созданном
репозитории с историей коммитов.
"""
