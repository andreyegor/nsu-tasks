...
read_num: #-->a0 also use: t0 t1 t2 t3 t4 t5
	li t0 0
	li t1 7
	li t2 '\n'
    li t3 '-'
    ...
    li t5 58
_read_num_loop:
    beq t1 zero _read_num_error

	read
	beq a0 t2 _read_num_end
	beq a0 t3 _read_num_negative
    blt a0 t4 _read_num_error
    bge a0 t5 _read_num_error
	addi a0 a0 -48
	...
	j _read_num_loop
_read_num_negative:
    bne t0 zero _read_num_error
    beq t3 zero _read_num_error
    li t3 0
    j _read_num_loop
_read_num_end:
    bne t3 zero _read_num_quit
    li t1 0x10000000
    add t0 t0 t1
_read_num_quit:
    mv a0 t0
...
write_num: # a0-> also use t0 t1 t2 t3
    mv t0 a0
    li t2 0x10000000
    and t3 t0 t2
    beq t3 zero _write_num_count
    sub t0 t0 t2
